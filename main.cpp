...
void initRendering() {
	...
	Image* image2 = loadBMP("FTI.bmp");
	_textureId2 = loadTexture(image2);
		Image* image3 = loadBMP("aldyth.bmp");
	_textureId3 = loadTexture(image3);
		Image* image4 = loadBMP("aldythh.bmp");
	_textureId4 = loadTexture(image4);
		Image* image5 = loadBMP("valentyno.bmp");
	_textureId5 = loadTexture(image5);
		Image* image6 = loadBMP("mayesthyco.bmp");
